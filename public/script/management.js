...
function loadLocationData() {
    fetch('../api/get_properties.php?action=get_locations')
...
function loadActivities(propertyId) {
    ...
    fetch(`../api/get_property_tasks.php?property_id=${propertyId}`)
    .then(response => response.json())
    .then(data => {
        if (data.success) {
...
function createActivityTask() {
    ...
    fetch('../api/add_property_task.php', {
        method: 'POST',
        body: formData
    })
    .then(response => response.json())
...
function loadProperties() {
    ...
    let url = '../api/get_properties.php?';
...
function updatePropertyTag(propertyId, newTag) {
    fetch('../api/update_property_tag.php', {
        method: 'POST',
        headers: {
            'Content-Type': 'application/json',
        },
